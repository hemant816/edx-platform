...
class SingleThreadQueryCountTestCase(ForumsEnableMixin, ModuleStoreTestCase):
    ...
    @ddt.data(
        ...
        (ModuleStoreEnum.Type.mongo, False, 1, 5, 2, 18, 5),
        (ModuleStoreEnum.Type.mongo, False, 50, 5, 2, 18, 5),
        # split mongo: 3 queries, regardless of thread response size.
        (ModuleStoreEnum.Type.split, False, 1, 3, 3, 18, 5),
        (ModuleStoreEnum.Type.split, False, 50, 3, 3, 18, 5),

        # Enabling Enterprise integration should have no effect on the number of mongo queries made.
        (ModuleStoreEnum.Type.mongo, True, 1, 5, 2, 18, 5),
        (ModuleStoreEnum.Type.mongo, True, 50, 5, 2, 18, 5),
        # split mongo: 3 queries, regardless of thread response size.
        (ModuleStoreEnum.Type.split, True, 1, 3, 3, 18, 5),
        (ModuleStoreEnum.Type.split, True, 50, 3, 3, 18, 5),
    )
    @ddt.unpack
